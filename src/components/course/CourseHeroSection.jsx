...
const CourseHeroSection = ({ courseCount }) => (
    <div className="relative overflow-hidden bg-gradient-to-r from-[#e91e63] via-[#f06292] to-[#e91e63]">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
            <div className="text-center text-white">
                ...
                <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight md:leading-snug">
                ...
                <div className="flex items-center justify-center gap-8 text-sm">
                    <div className="flex items-center gap-2"><BookOpen size={18} /><span>{courseCount}+ Courses</span></div>
                    <div className="flex items-center gap-2"><Users size={18} /><span>50k+ Students</span></div>
                    <div className="flex items-center gap-2"><Award size={18} /><span>Expert Instructors</span></div>
                </div>
            </div>
        </div>
